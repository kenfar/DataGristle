...
class TestEmptyFile(object):
    ...
    def test_empty_file(self):
        ...
        assert get_value(runner.std_out, 'file_analysis_results', 'main', 'main', 'records_read')  is None
    ...
    def test_empty_file_with_header(self):
        ...
        assert get_value(runner.std_out, 'file_analysis_results', 'main', 'main', 'records_read') == '1'
...
class TestOutputFormattingAndContents(object):
        ...
        with open(out_fqfn, 'r') as csv_inbuf:
            for record in csv.reader(csv_inbuf, dialect=mydialect):
                ...
                if division == 'file_analysis_results':
                    ...
                    assert subsection in ['main', 'top_values', 'meta_counts']
    ...
    def test_file_info(self):
        pp(self.file_struct)
        assert self.file_struct['records_read'] == '5'
        assert self.file_struct['records_rejected_missing_fields'] == '0'
        assert self.file_struct['records_rejected_extra_fields'] == '0'
    ...
    def test_field_info(self):
        ...
        assert self.field_struct['field_1']['main']['known_values'] == '5'
    ...
    def test_top_value_info(self):
        pp(self.field_struct)
        assert self.field_struct['field_0']['top_values']['top_known_values'] == 'not shown - all are unique'
...
class TestReadLimit(object):
    ...
    def test_limits(self):
        assert 'est' in self.file_struct['records_read']
...
class TestMaxFreq(object):
    ...
    def test_limits(self):
        assert self.file_struct['records_read'] == '19'
