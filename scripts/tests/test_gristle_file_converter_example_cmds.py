...
class TestSampleConfigs(object):
    ...
    def setup_method(self, method):
        self.temp_dir = tempfile.mkdtemp(prefix='gristle_file_converter_')
        self.out_fqfn = pjoin(self.temp_dir, 'testfile.csv.sliced')
        self.cmd = None
    ...
    def make_command(self,
        ...
        self.cmd = f''' {pjoin(SCRIPT_DIR, 'gristle_file_converter')}   \
                        -o {self.out_fqfn}
                        --verbosity debug
