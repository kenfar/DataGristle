    ...
    def setup_method(self, method):
        ...
        self.kwargs = {'name': 'foobar',
                       ...
                       'inclusion_phase': {
                           ...
                           #'file_size': 'range',
                           'file_type': 'file',
                           'fntime_filter_regex': r'_20[1-3]\d-[0-1]\d-[0-3]\d_',
                           'fntime_extract_regex': r'20[1-3]\d-[0-1]\d-[0-3]\d',
                           'fntime_format': '%Y-%m-%d',
                           'fntime_op': 'lt',
...
class TestFileAnalyzer_misc(object):
...
class TestFileAnalyzer_check_times(object):
    ...
    def test_mtime_op_argdate_10s_vs_100sfile(self):
        (_, fqfn) = tempfile.mkstemp(prefix='ProcessorTestIn_', dir=self.tmpdir)
        curr_time = time.time()
...
class TestFileAnalyzerFileNameDate(object):
    ...
    def create_file(self, age, suffix='_foo'):
        (_, fqfn) = tempfile.mkstemp(prefix='ProcessorTestIn_', suffix=suffix, dir=self.tmpdir)
    ...
    def test_file_with_no_date_through_filter_regex(self):
        ...
        _ = self.create_file(age=86400*10, suffix='foo_%s_bear' % fdate)
        fa = mod.FileAnalyzer({}, {})
    ...
    def test_failed_extract_regex(self):
        ...
        with pytest.raises(ValueError):
            _ = fa._filenamedate_op_argdate(fqfn, filter_regex, ext_regex, '%Y-%m-%d', 'lt', '10d')
    ...
    def test_bad_format(self):
        ...
        ext_regex = fdate               # looks like '2014-03-14'
        filter_regex = '_%s_' % ext_regex  # looks like '_2014-03-14_'
        fa._filenamedate_op_argdate(fqfn, filter_regex, ext_regex, '%9', 'lt', '10d') is None
    ...
    def test_bad_op(self):
        ...
        with pytest.raises(AssertionError):
            _ = fa._filenamedate_op_argdate(fqfn, filter_regex, ext_regex, '%Y-%m-%d', 'gg', '10d')
...
class TestGetRegexSubstring(object):
    ...
    def test_extract_only(self):
        ...
        extract_regex = r'20[1-3]\d-[0-1]\d-[0-3]\d'
        ...
        fqfn = '20140101'
        extract_regex = r'201[3-9][0-1][0-9][0-3][0-9]'
    ...
    def test_filter_and_extract_mismatch_on_filter(self):
        fqfn = 'ProcessorTestIn_blahfoobarf_baz.gz'
        filter_regex = r'_20[1-3]\d-[0-1]\d-[0-3]\d_'
        extract_regex = r'20[1-3]\d-[0-1]\d-[0-3]\d'
    ...
    def test_filter_and_extract_mismatch_on_extract(self):
        ...
        filter_regex = r'_20[1-3]\d-[0-1]\d-[0-3]\d_'
        extract_regex = r'2099-[0-1]\d-[0-3]\d'
        with pytest.raises(ValueError):
...
def create_file(self, age=None, suffix='foo', mydir=None):
    if mydir:
        (_, fqfn) = tempfile.mkstemp(prefix='ProcessorTestIn_',
